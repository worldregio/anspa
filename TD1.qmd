...
# Des individus aux interactions


## Rouge et noir

- Q1: Combien y-a-t-il d'individus rouges et noirs ?
...
- Q2 : Combien y-a-t-il d'interactions possibles entre individus d'un même groupe ?
...
- Attention : un individu n'interagit pas avec lui-même !


- Q3 : Combien y-a-t-il d'interactions entre individus de groupes différents ?
...
- Q1: Combien y-a-t-il d'individus de chaque famille

```{r}
tab<-table(map2$family)
tab
```
