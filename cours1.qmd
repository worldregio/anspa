...
On y voit cependant plus clair si on tente de distinguer dans l'analyse spatiale ce qui relève de l'analyse des **[formes]{.mark}** et de celle des **[processus]{.mark}**. C'est à partir de cette distinction que T. Saint-Julien et D. Pumain ont organisé leur manuel sur l'analyse spatiale en deux volumes portant respectivement sur les localisations @pumain2010loc et sur les interactions @pumain2010int.
